...
namespace SmokeTestTool
{
    class Div
    {
        ...
        public List<string> allSourceDivs { get; set; }
        public void GetAllSourceDivs(string urlAddress, ref TreeNode Result)
        {
        ...
        private void FetchSourceLinksFromSource(string htmlSource, ref TreeNode Result)
        {
            ...
            List<string> listOfSpans = htmlSource.ExtractFromString("<div", "</div>");
