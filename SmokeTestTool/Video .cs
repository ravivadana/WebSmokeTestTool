...
namespace SmokeTestTool
{
    class Video
    {
        ...
        public List<string> allSourceVideos { get; set; }
        public void GetAllSourceVideos(string urlAddress, ref TreeNode Result)
        {
        ...
        private void FetchSourceLinksFromSource(string htmlSource, ref TreeNode Result)
        {
            ...
            List<string> listOfSpans = htmlSource.ExtractFromString("<video", "</video>");
